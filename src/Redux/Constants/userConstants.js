...
export const LIKE_MOIVE_REQUEST = "LIKE_MOVIE_REQUEST";
export const LIKE_MOIVE_SUCCESS = "LIKE_MOVIE_SUCCESS";
export const LIKE_MOIVE_FAIL = "LIKE_MOVIE_FAIL";
export const LIKE_MOIVE_RESET = "LIKE_MOVIE_RESET";
